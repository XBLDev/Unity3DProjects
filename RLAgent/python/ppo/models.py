...
class PPOModel(object):
    ...
    def get_activation_map(self, sess, currinput, layer):
        result = sess.run(layer, feed_dict={self.observation_in: currinput})

##        result = sess.run(self.conv1, feed_dict={self.observation_in: currinput})
