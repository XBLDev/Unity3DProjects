...
class UnityEnvironment(object):
    ...
    @staticmethod
    def _process_pixels(self, image_bytes=None, bw=False):
        """
...
##        a[0][0].imshow(s, interpolation="nearest", cmap='gray')
##        a[0][0].set_xticks(())
##        a[0][0].set_yticks(())
##        plt.draw()
##        plt.pause(0.01)
        self._current_image = s
        return s
    ...
    def _get_state_image(self, bw):
        ...
        s = self._process_pixels(self, image_bytes=s, bw=bw)
