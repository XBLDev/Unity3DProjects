...
namespace HoloToolkit.Examples.SharingWithUNET
{
    ...
    public class PlayerController : NetworkBehaviour
    {
        ...
        public GameObject avartarSquare;
        public GameObject avartarCylinder;
        /// <summary>
        ...
        private void Update()
        {
            ...
            if (!isLocalPlayer)
            {
                ...
                if(cursorSphere && spawnpos && avartarSquare && avartarCylinder)
                {
                    cursorSphere.gameObject.SetActive(false);
                    spawnpos.gameObject.SetActive(false);
                    avartarSquare.gameObject.SetActive(false);
                    avartarCylinder.gameObject.SetActive(false);
                }
